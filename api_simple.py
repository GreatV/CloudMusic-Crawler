...
# @Author: GreatV
# @Date: 2017-04-16
# 本 api 由 https://github.com/darknessomi/musicbox/blob/master/NEMbox/api.py 修改而成
...
# artist_id = 6452
# artist_music(artist_id)
# song_id = 418603077
# print get_music_lyric(song_id)
# print get_music_comments(song_id)